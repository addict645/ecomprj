# Generated by Django 5.0 on 2024-10-06 19:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=10, max_length=13, prefix='cat', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='0.99', max_digits=99999999999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='0.99', max_digits=99999999999999999999)),
                ('total', models.DecimalField(decimal_places=2, default='0.99', max_digits=99999999999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_price', models.DecimalField(decimal_places=2, default=1.99, max_digits=20)),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=4, max_length=7, prefix='sku', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=10, max_length=13, prefix='ven', unique=True)),
